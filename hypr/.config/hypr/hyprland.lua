...
hl.bind(mainMod .. " + ESCAPE + DELETE", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
--scroll to move apps to workspaces
